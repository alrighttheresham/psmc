...
exports.getTrapDetailsForTrap = function(trapOid, callback, data) {
    var query = "SELECT * FROM Notifications, NotificationValues WHERE id = notification_id AND trapOid = '" + trapOid + "';";
