...
exports.getTrapDetailsForTrap = function(trapOid, afterDate, callback, data) {
    var afterDateQuery = '';
    if(afterDate !== '') {
        afterDateQuery = "AND trapTime > '" + afterDate + "'"; 
    }
    
    var query = "SELECT * FROM Notifications, NotificationValues WHERE id = notification_id AND trapOid = '" + trapOid + "' " + afterDateQuery + ";";
