                    ...
                    function (error, data, res) {
                        if (error instanceof Error) {
                            ...
                            if (res.statusCode == "200") {
                                ...
                                helper.not200(res, "Network Element Groups");
                            }
                        }
                    });
                    ...
                    function (error, data, res) {
                        if (error instanceof Error) {
                            ...
                            if (res.statusCode == "200") {
                                ...
                                helper.not200(res, "Unreachable Network Elements");
                            }
                        }
                    });
            } else if (opts.detail) {
                    ...
                    function (error, data, res) {
                        if (error instanceof Error) {
                            ...
                            if (res.statusCode == "200") {
                                ...
                                helper.not200(res, "Network Element Types");
                            }
                        }
                    });
            } else {
                    ...
                    function (error, data, res) {
                        if (error instanceof Error) {
                            ...
                            if (res.statusCode == "200") {
                                ...
                                helper.not200(res, "Network Elements");
                            }
                        }
                    });
            }
